...
export const WORKOUT_A: MainWorkout = {
  ...
  exercises: [
    ...
    },
    {
      id: 'goblet_squat',
      driver_type: 'strength_muscle',
      progress_by: 'reps_then_load_then_tempo',
      phase_1: { load_kg: 8, sets: 3, reps: 12, rest_sec: 90 },
      phase_2: { load_kg: 8, sets: 4, reps: 15, rest_sec: 90 },
      phase_3: { load_kg: 10, sets: 4, reps: 15, tempo: '2sec_pause_at_bottom', rest_sec: 90 },
      phase_4_deload: { load_kg: 8, sets: 2, reps: 10, rest_sec: 90 },
    },
    {
      id: 'jump_squat',
    ...
    },
    {
      id: 'lunges',
      driver_type: 'strength_muscle',
      progress_by: 'reps_then_load',
      phase_1: { load_kg: 0, sets: 3, reps_per_leg: 10, rest_sec: 60, note: 'bodyweight only, week 1-2' },
      phase_2: { load_kg: 8, sets: 3, reps_per_leg: 12, rest_sec: 60 },
      phase_3: { load_kg: 10, sets: 3, reps_per_leg: 12, rest_sec: 60 },
      phase_4_deload: { load_kg: 0, sets: 2, reps_per_leg: 10, rest_sec: 60 },
    },
    {
...
export const EXERCISE_CATALOG: Record<string, ExerciseMeta> = {
  ...
  goblet_squat: { id: 'goblet_squat', name: 'Goblet Squat', category: 'Legs', metricType: 'reps', color: 'emerald', description: 'Deep squat depth, chest up.' },
  ...
  lunges: { id: 'lunges', name: 'Lunges', category: 'Legs', metricType: 'reps_per_leg', color: 'emerald', description: 'Controlled step-to-step.' },
