...
export const WORKOUT_A: MainWorkout = {
  ...
  exercises: [
    ...
    },
    {
      ...
      driver_type: 'strength_muscle',
      progress_by: 'reps_then_tempo',
      phase_1: { sets: 3, reps: 12, rest_sec: 90, note: 'bodyweight only' },
      phase_2: { sets: 4, reps: 15, rest_sec: 90, note: 'bodyweight only' },
      phase_3: { sets: 4, reps: 15, tempo: '2sec_pause_at_bottom', rest_sec: 90, note: 'bodyweight only' },
      phase_4_deload: { sets: 2, reps: 10, rest_sec: 90, note: 'bodyweight only' },
    },
    {
      id: 'jump_squat',
      driver_type: 'conditioning_plyometric',
      progress_by: 'volume_only_never_load',
      phase_1: { sets: 2, reps: 5, rest_sec: 60, note: 'Low volume from day 1 - ramping intensity, not skipping' },
      phase_2: { sets: 2, reps: 10, rest_sec: 60 },
      phase_3: { sets: 2, reps: 15, rest_sec: 60 },
      phase_4_deload: { sets: 1, reps: 8, rest_sec: 60 },
    },
    {
      id: 'jump_lunge',
      driver_type: 'conditioning_plyometric',
      progress_by: 'volume_only_never_load',
      phase_1: { sets: 2, reps_per_leg: 4, rest_sec: 60 },
      phase_2: { sets: 2, reps_per_leg: 8, rest_sec: 60 },
      phase_3: { sets: 2, reps_per_leg: 12, rest_sec: 60 },
      phase_4_deload: { sets: 1, reps_per_leg: 6, rest_sec: 60 },
    },
    {
      id: 'lunges',
      driver_type: 'strength_muscle',
      progress_by: 'reps_then_tempo',
      phase_1: { sets: 3, reps_per_leg: 10, rest_sec: 60, note: 'bodyweight only' },
      phase_2: { sets: 3, reps_per_leg: 12, rest_sec: 60, note: 'bodyweight only' },
      phase_3: { sets: 3, reps_per_leg: 12, rest_sec: 60, note: 'bodyweight only' },
      phase_4_deload: { sets: 2, reps_per_leg: 10, rest_sec: 60, note: 'bodyweight only' },
    },
    {
...
export const EXERCISE_CATALOG: Record<string, ExerciseMeta> = {
  ...
  goblet_squat: { id: 'goblet_squat', name: 'Bodyweight Squat', category: 'Legs', metricType: 'reps', color: 'emerald', description: 'Deep squat depth, chest up. Bodyweight only.' },
  jump_squat: { id: 'jump_squat', name: 'Jump Squat (Bodyweight)', category: 'Legs', metricType: 'reps', color: 'rose', description: 'Explosive power, soft landing.' },
  jump_lunge: { id: 'jump_lunge', name: 'Jump Lunge (Bodyweight)', category: 'Legs', metricType: 'reps_per_leg', color: 'rose', description: 'Explosive alternating switch, soft landing.' },
  lunges: { id: 'lunges', name: 'Lunges', category: 'Legs', metricType: 'reps_per_leg', color: 'emerald', description: 'Controlled step-to-step. Bodyweight only.' },
